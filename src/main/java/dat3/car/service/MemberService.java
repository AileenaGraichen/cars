...
public class MemberService {
    ...
    public List<MemberResponse> getMembers(boolean includeAll) {
        ...
        // List<MemberResponse> response = members.stream().map(m -> new MemberResponse(m,includeAll)).collect(Collectors.toList());
        return response;
    }
    ...
    public MemberResponse addMember(MemberRequest body) {
        ...
        Member m = MemberRequest.getMemberEntity(body);
    ...
    public MemberResponse findById(String username) {
        Member m = memberRepository.findById(username).orElseThrow(()-> new ResponseStatusException(HttpStatus.NOT_FOUND,"Member with this username does not exist"));
        return new MemberResponse(m,true);
    }
